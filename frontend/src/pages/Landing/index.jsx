...
export default function Landing() {
  ...
  const getMovies = async () => {
    try {
      setIsLoading(true);
      const currentMoviesData = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/landing/current`);
      const upcomingMoviesData = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/landing/upcoming`);
